...
const HALF_BUFFER_CAP = 14;   // 半框缓存区容量（待齐套料框，ModelConfig.half_buffer_capacity）
const KIT_BUFFER_CAP = 16;    // 齐套缓存区容量（已齐套待取走，ModelConfig.kit_buffer_capacity）
