          ...
          },
          {
            ...
            children: (
              <>
                ...
                <ParamRow label="齐套缓存容量" tooltip="已齐套待取走料框的齐套缓存区容量（默认16框）" value={params.kit_buffer_capacity} min={5} max={500} step={5} unit="框" onChange={(v) => set('kit_buffer_capacity', v)} />
              ...
              <>
                <Row align="middle" style={{ marginBottom: 12 }}>
                  <Col span={8}>
                    ...
                    <Tooltip title="SA+Tabu / GA+LNS 为标量搜索；NSGA-II 运行多目标 Pareto 进化，仅在模型权重可用时加入 DQN 机器码种子">
                  ...
                  <Col span={16}>
                    <Select
                      ...
                      options={[
                        ...
                        { value: 'dq_nsga2', label: 'NSGA-II（可选DQN种子）' },
                      ]}
                    />
                  </Col>
                </Row>
